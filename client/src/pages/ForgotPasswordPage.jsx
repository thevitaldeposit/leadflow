  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-app-bg p-4">
      <div className="w-full max-w-sm bg-surface rounded-2xl shadow-sm p-8">
        ...
        {sent ? (
          <>
            <h1 className="text-lg font-semibold text-center text-content">Check your email</h1>
            <p className="text-sm text-muted text-center mt-2 mb-6">
              We've sent you a reset link. Follow it to choose a new password.
            </p>
            <Link
              to="/login"
              className="block w-full py-2.5 rounded-lg bg-accent text-content font-medium text-sm text-center hover:opacity-90 transition-opacity"
            >
              Back to login
            </Link>
          </>
          ...
          <>
            <h1 className="text-lg font-semibold text-center text-content">Forgot your password?</h1>
