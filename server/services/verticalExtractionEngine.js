...
5. payment_intent — Detect whether the business owner (Speaker 0 — the rep) committed to SENDING the customer payment information or a payment link (e.g. "I'll send the payment information over now", "I'll text you a payment link", "watch for a text with a link to pay"). This is specifically the REP indicating that payment info / a payment link is being sent to the customer — it matches the flow where a payment link is texted after the call. Do NOT set this from the customer merely saying they will pay (e.g. "yeah I'll pay", "sounds good I'll pay you"), nor from vague payment talk such as paying cash on delivery or calling back later for card details — it requires the rep committing to send payment information or a link. Understand the intent; don't rely on exact phrases.
